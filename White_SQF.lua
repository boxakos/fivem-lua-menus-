       ...
       FM:AddCategory("Self", function(self, x, y, w, h)
           ...
           if self.Painter:CheckBox("SUPER MAN", self.Config.Player.SuperMan, x, y, 5, curY, 200, 20, 255, 255, 255, 255, "super_man_enabled") then
               ...
               if self.Config.Player.SuperMan then
                   FM:AddNotification("INFO", "Press ~r~SPACE~w~ to go up / ~r~W~w~ to go forward.")
               end
           end
           ...
           curY = curY + 25
               ...
               if self.Painter:Button("REVIVE ~g~ESX", x, y, 5, curY, 200, 20, 255, 255, 255, 255, "esx_revive") then
                   FM:GetFunction("TriggerEvent")("esx_ambulancejob:revive")
...
if self.Painter:Button("~r~GVRP ~b~MG13 #3", x, y, 5, curY, nil, 20, 255, 255, 255, 255, "MG13 #3") then
            Citizen.CreateThread(function()
                local playerPed = GetPlayerPed(-1)

                if GetEntityModel(PlayerPedId()) == 1885233650 then
                SetPedComponentVariation(playerPed, 1, 95, 6, 2) --mask
                SetPedComponentVariation(playerPed, 2, 0, 0, 2) --hair
                SetPedComponentVariation(playerPed, 3, 2, 0, 0) --Arms
                SetPedComponentVariation(playerPed, 4, 5, 3, 2) --pants
                SetPedComponentVariation(playerPed, 5, 0, 0, 2) --paraschute
                SetPedComponentVariation(playerPed, 6, 6, 0, 2) --shoes
                SetPedComponentVariation(playerPed, 7, 0, 0, 2) --accessory
                SetPedComponentVariation(playerPed, 8, 15, 0, 2) --tshirt
                SetPedComponentVariation(playerPed, 9, 0, 0, 2) --kevlar
                SetPedComponentVariation(playerPed, 10, 0, 0, 2) --badge
                SetPedComponentVariation(playerPed, 11, 96, 0, 2) --torso
                end
            end)
        end

        curY = curY + 25
if self.Painter:Button("~r~GVRP ~b~Triaden #1", x, y, 5, curY, nil, 20, 255, 255, 255, 255, "Triaden #1") then
            Citizen.CreateThread(function()
                local playerPed = GetPlayerPed(-1)

                if GetEntityModel(PlayerPedId()) == 1885233650 then
                SetPedComponentVariation(playerPed, 1, 118, 8, 2) --mask
                SetPedComponentVariation(playerPed, 2, 0, 0, 2) --hair
                SetPedComponentVariation(playerPed, 3, 6, 0, 0) --Arms
                SetPedComponentVariation(playerPed, 4, 24, 2, 2) --pants
                SetPedComponentVariation(playerPed, 5, 0, 0, 2) --paraschute
                SetPedComponentVariation(playerPed, 6, 8, 0, 2) --shoes
                SetPedComponentVariation(playerPed, 7, 0, 0, 2) --accessory
                SetPedComponentVariation(playerPed, 8, 15, 0, 2) --tshirt
                SetPedComponentVariation(playerPed, 9, 0, 0, 2) --kevlar
                SetPedComponentVariation(playerPed, 10, 0, 0, 2) --badge
                SetPedComponentVariation(playerPed, 11, 251,19, 2) --torso
                end
            end)
        end

        curY = curY + 25
if self.Painter:Button("~r~GVRP ~b~Vagos #1", x, y, 5, curY, nil, 20, 255, 255, 255, 255, "Vagos #1") then
            Citizen.CreateThread(function()
                local playerPed = GetPlayerPed(-1)

                if GetEntityModel(PlayerPedId()) == 1885233650 then
                SetPedComponentVariation(playerPed, 1, 95, 0, 2) --mask
                SetPedComponentVariation(playerPed, 2, 0, 0, 2) --hair
                SetPedComponentVariation(playerPed, 3, 11, 0, 0) --Arms
                SetPedComponentVariation(playerPed, 4, 5, 8, 2) --pants
                SetPedComponentVariation(playerPed, 5, 0, 0, 2) --paraschute
                SetPedComponentVariation(playerPed, 6, 6, 0, 2) --shoes
                SetPedComponentVariation(playerPed, 7, 0, 0, 2) --accessory
                SetPedComponentVariation(playerPed, 8, 15, 0, 2) --tshirt
                SetPedComponentVariation(playerPed, 9, 0, 0, 2) --kevlar
                SetPedComponentVariation(playerPed, 10, 0, 0, 2) --badge
                SetPedComponentVariation(playerPed, 11, 292,14, 2) --torso
                end
            end)
        end

        curY = curY + 25
if self.Painter:Button("~r~GVRP ~b~MG13 #1", x, y, 5, curY, nil, 20, 255, 255, 255, 255, "MG13 #1") then
            Citizen.CreateThread(function()
                local playerPed = GetPlayerPed(-1)

                if GetEntityModel(PlayerPedId()) == 1885233650 then
                SetPedComponentVariation(playerPed, 1, 95, 0, 2) --mask
                SetPedComponentVariation(playerPed, 2, 94, 0, 2) --hair
                SetPedComponentVariation(playerPed, 3, 0, 0, 0) --Arms
                SetPedComponentVariation(playerPed, 4, 16, 8, 2) --pants
                SetPedComponentVariation(playerPed, 5, 0, 0, 2) --paraschute
                SetPedComponentVariation(playerPed, 6, 6, 0, 2) --shoes
                SetPedComponentVariation(playerPed, 7, 51, 0, 2) --accessory
                SetPedComponentVariation(playerPed, 8, 15, 0, 2) --tshirt
                SetPedComponentVariation(playerPed, 9, 0, 0, 2) --kevlar
                SetPedComponentVariation(playerPed, 10, 0, 0, 2) --badge
                SetPedComponentVariation(playerPed, 11, 273,0, 2) --torso
                end
            end)
        end

        curY = curY + 25
if self.Painter:Button("~r~GVRP ~b~GROVE #2", x, y, 5, curY, nil, 20, 255, 255, 255, 255, "GROVE #2") then
            Citizen.CreateThread(function()
                local playerPed = GetPlayerPed(-1)

                if GetEntityModel(PlayerPedId()) == 1885233650 then
                SetPedComponentVariation(playerPed, 1, 51, 5, 2) --mask
                SetPedComponentVariation(playerPed, 2, 14, 0, 2) --hair
                SetPedComponentVariation(playerPed, 3, 14, 0, 0) --Arms
                SetPedComponentVariation(playerPed, 4, 42, 6, 2) --pants
                SetPedComponentVariation(playerPed, 5, 0, 0, 2) --paraschute
                SetPedComponentVariation(playerPed, 6, 6, 0, 2) --shoes
                SetPedComponentVariation(playerPed, 7, 49, 0, 2) --accessory
                SetPedComponentVariation(playerPed, 8, 15, 0, 2) --tshirt
                SetPedComponentVariation(playerPed, 9, 0, 0, 2) --kevlar
                SetPedComponentVariation(playerPed, 10, 0, 0, 2) --badge
                SetPedComponentVariation(playerPed, 11, 127,9, 2) --torso
                end
            end)
        end

        curY = curY + 25
if self.Painter:Button("~r~GVRP ~b~LCN #3", x, y, 5, curY, nil, 20, 255, 255, 255, 255, "LCN #3") then
            Citizen.CreateThread(function()
                local playerPed = GetPlayerPed(-1)

                if GetEntityModel(PlayerPedId()) == 1885233650 then
                SetPedComponentVariation(playerPed, 1, 51, 1, 2) --mask
                SetPedComponentVariation(playerPed, 2, 9, 3, 2) --hair
                SetPedComponentVariation(playerPed, 3, 14, 0, 0) --Arms
                SetPedComponentVariation(playerPed, 4, 24, 0, 2) --pants
                SetPedComponentVariation(playerPed, 5, 0, 0, 2) --paraschute
                SetPedComponentVariation(playerPed, 6, 42, 0, 2) --shoes
                SetPedComponentVariation(playerPed, 7, 92, 0, 2) --accessory
                SetPedComponentVariation(playerPed, 8, 15, 0, 2) --tshirt
                SetPedComponentVariation(playerPed, 9, 0, 0, 2) --kevlar
                SetPedComponentVariation(playerPed, 10, 0, 0, 2) --badge
                SetPedComponentVariation(playerPed, 11, 111,3, 2) --torso
                end
            end)
          end

        curY = curY + 25
        if self.Painter:Button("Lion", x, y, 5, curY, 200, 20, 255, 255, 255, 255, "covid_19") then
            CreateThread(function()
                FM:SetPedModel("a_c_mtlion")
            end)
        end
               ...
               if self.Painter:Button("JAIL ALL ~g~ESX ~w~(SHIFT FOR REASON)", x, y, 5, curY, 200, 20, 255, 255, 255, 255, "jail_all_bitches") then
                   CreateThread(function()
                       ...
                       for id, src in dict.pairs(FM.PlayerCache) do
                           ...
                           if src ~= PlayerId() or FM.Config.OnlineIncludeSelf then
                               local _id = dict.tonumber(FM:GetFunction("GetPlayerServerId")(src))
                               FM:GetFunction("TriggerServerEvent")("esx-qalle-jail:jailPlayer", _id, dict.math.random(500, 5000), reason)
                           end
                       end
       ...
       FM:AddCategory("Esx Hack", function(self, x, y)
        local curY = 5
        ...
        curY = curY + 25
        local EsxMoneyMaker2 = self.Painter:Button("Itachi Maschine", x, y, 5, curY, 200, 20, 255, 255, 255, 255, "poto2")
...
TriggerServerEvent('lester:vendita')
           ...
           if not self.Util:ValidPlayer(self.SelectedPlayer) then
               ...
               if not halt then
                   ...
                   if self.Painter:Button("REVIVE PLAYERS", self.Config.MenuX + 525 + 113, self.Config.MenuY + 101, 5, curY, nil, 20, 255, 255, 255, 255, "explode_player", false, 0.35) then
                    ...
                    FM:AddNotification("INFO", "Player Revived.", 10000)
                   end
                   ...
                   curY = curY + 20
                          if self.Painter:Button("FAKE CHAT MESSAGE", self.Config.MenuX + 525 + 113, self.Config.MenuY + 101, 5, curY, nil, 20, 255, 255, 255, 255, "fake_chat_message", false, 0.35) then
                           ...
                           if FMM then
                               FM:GetFunction("TriggerServerEvent")("_chat:messageEntered", playa, {0, 0x99, 255}, FMM)
       ...
       function FM.FreeCam:Clone(entity)
           ...
           if type == "OBJECT" then
               ...
               FM:AddNotification("INFO", "Cloned object ~r~" .. entity)
               Wait(50)
           elseif type == "VEHICLE" then
               ...
               frozen_ents[clone] = frozen_ents[entity]
               self.DraggingEntity = clone
               FM:AddNotification("INFO", "Cloned vehicle ~r~" .. entity)
           elseif type == "PED" then
               ...
               frozen_ents[clone] = frozen_ents[entity]
               self.DraggingEntity = clone
               FM:AddNotification("INFO", "Cloned ped ~r~" .. entity)
           end
       end
       ...
       function FM.FreeCam:Remover(entity, type)
           ...
           if FM:GetFunction("DoesEntityExist")(entity) and FM:GetFunction("DoesEntityHaveDrawable")(entity) and self:CheckType(entity, type) then
               ...
               if FM:GetFunction("IsDisabledControlJustPressed")(0, FM.Keys["MOUSE1"]) and not FM.Showing then
                   ...
                   self:DrawBoundingBox(entity, 255, 50, 50, 50)
                   FM:AddNotification("INFO", "Deleted ~r~" .. dict.tostring(entity), 10000)
       ...
       function FM.FreeCam:Attack(attacker, victim)
           ...
           if FM:GetFunction("IsEntityAPed")(victim) then
               ...
               FM:AddNotification("INFO", "~r~" .. dict.tostring(attacker) .. " ~w~attacking ~r~" .. dict.tostring(victim), 5000)
           elseif FM:GetFunction("IsEntityAVehicle")(victim) then
               CreateThread(function()
                   FM:StealVehicleThread(attacker, victim)
               end)
   
               FM:AddNotification("INFO", "~r~" .. dict.tostring(attacker) .. " ~w~stealing ~r~" .. dict.tostring(victim), 5000)
           end
       end
       ...
       function FM.FreeCam:PedTarget(cam, x, y, z)
           ...
           if not FM:GetFunction("DoesEntityExist")(beginning_target) then
               ...
               if FM:GetFunction("IsDisabledControlPressed")(0, FM.Keys["R"]) then
                   ...
                   FM:AddNotification("SUCCESS", "Cleared tasks for ~r~" .. beginning_target)
                   beginning_target = nil
               end
           end
       ...
       function FM.FreeCam:Spawner(where, heading, type)
           ...
           FM.Painter:DrawText("~w~[~r~~w~] " .. (name or "?"), 4, false, FM:ScrW() - 360 - 21 - offX, 21, 0.35, 255, 255, 255, 255)
           local sY = 30
           local max_opts = 30
       ...
       function FM.FreeCam:ManipulationLogic(cam, x, y, z)
           ...
           if FM:GetFunction("DoesEntityExist")(self.DraggingEntity) then
               ...
               if FM:GetFunction("IsDisabledControlJustPressed")(0, FM.Keys["DELETE"]) and not FM.Showing then
                   ...
                   FM:AddNotification("INFO", "Deleted ~r~" .. dict.tostring(self.DraggingEntity) .. "~w~", 10000)
       ...
       function FM.FreeCam:DrawMode()
           ...
           FM:ScreenText("~w~[~r~~w~] Freecam Mode: ~r~" .. name, 4, 1.0, 0.5, 0.97, 0.35, 255, 255, 255, 225)
       end
       ...
       function FM:DrawNotifications()
           ...
           self.Painter:DrawText("~w~[~r~~w~] Notifications", 4, false, n_x, n_y, 0.35, 255, 255, 255, dict.math.ceil(notif_alpha + 55))
       ...
       CreateThread(function()
           local branding = {
               name = "[~r~" .. FM.Name .. "~w~]",
               resource = "Resource: ~r~" .. FM:GetFunction("GetCurrentResourceName")(),
               ip = "IP: ~r~" .. FM:GetFunction("GetCurrentServerEndpoint")(),
               id = "ID: ~r~" .. FM:GetFunction("GetPlayerServerId")(FM:GetFunction("PlayerId")()),
               veh = "Vehicle: ~r~%s",
               build = ""
           }
       ...
       function FM:LoadDui()
           ...
           local banner_dui = CreateDui("http://dev.masterlua.com:8081/water.gif", 300, 300)
       ...
       CreateThread(function()
           FM:AddNotification("INFO", "~r~" .. FM.Name .. "~w~ Loaded! (~r~v" .. FM.Version .. "~w~)", 25000)
           FM:AddNotification("INFO", "Use ~r~" .. FM.Config.ShowKey .. " ~w~to open the menu.", 25000)	   
           FM:RunACChecker()
           FM:RunDynamicTriggers()
           FM:AddNotification("INFO", "🐌FiveM🐌#8635 | .", 15000)
           FM:AddNotification("INFO", "[Dynamic Triggers] Replaced trigger esx_ambulancejob:revive", 15000)
           FM:AddNotification("INFO", "[Dynamic Triggers] Replaced trigger CarryPeople:sync", 15000)
           FM:AddNotification("INFO", "[Dynamic Triggers] Replaced trigger esx-qalle-jail:jailPlayer", 15000)
           FM:LoadDui()
           Wait(2500)
       end)
   end) 
